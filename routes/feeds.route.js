...
feedsrouter.delete('/:id', AuthenticateToken, delete_new_feed);
...
feedsrouter.delete('/type', AuthenticateToken, delete_new_type);
feedsrouter.put('/type/:id', AuthenticateToken, update_new_type);

// ? This is the routes for Author
feedsrouter.post('/author', AuthenticateToken, insert_new_author);
feedsrouter.delete('/author/:id', AuthenticateToken, delete_new_author);
feedsrouter.put('/author/:id', AuthenticateToken, update_new_author);
